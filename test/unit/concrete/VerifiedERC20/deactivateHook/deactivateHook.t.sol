...
contract DeactivateHookConcreteTest is VerifiedERC20Test {
  ...
  function test_WhenTheHookIsNotActivated() external whenTheCallerIsTheOwner {
    ...
    vm.expectRevert(
      abi.encodeWithSelector(
        IVerifiedERC20.VerifiedERC20_HookNotActivated.selector,
  ...
  function test_WhenTheHookIsTheOnlyElementInTheArray()
    external
    ...
    whenTheHookIsActivated
  {
    ...
    assertEq(
      uint8(verifiedERC20.hookToEntrypoint({ _hook: address(hook) })),
      0
    );
  }
  ...
  function test_WhenTheHookIsNotTheLastElementInTheArray()
    external
    whenTheCallerIsTheOwner
    whenTheHookIsActivated
  {
  ...
  function testGas_deactivateHook()
    external
    whenTheCallerIsTheOwner
    whenTheHookIsActivated
  {
