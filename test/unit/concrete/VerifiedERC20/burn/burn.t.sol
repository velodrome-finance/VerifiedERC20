...
contract BurnConcreteTest is VerifiedERC20Test {
    ...
    function test_WhenTheAmountIsGreaterThanTheAllowance() external whenTheAccountPassedIsNotTheZeroAddress {
    ...
    modifier whenTheAmountIsSmallerOrEqualToTheAllowance() {
        ...
        verifiedERC20.approve({spender: address(this), value: 1000 + 1});
        _;
    }
        ...
        whenTheAccountPassedIsNotTheZeroAddress
    {
        ...
        assertEq(verifiedERC20.allowance({spender: address(this), owner: _account}), 1000 + 1 - _amount);
    }
}
